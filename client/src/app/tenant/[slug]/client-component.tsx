...
export default function TenantDashboardClient({ tenant }: { tenant: Tenant }) {
  return (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                ...
                <p className="text-gray-300">Access your workspace via {tenant.slug}.cavyor.in with custom branding</p>
              </div>
            </div>
            <div className="flex items-start space-x-4">
